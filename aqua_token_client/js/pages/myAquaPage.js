...
$("#createFishModal").on("shown.bs.modal", function() {
    ...
    $('#addFish').click(function() {
        ...
        //Trigger the fish creation in FishCreation.js
...
//When opening the Mate Modal, check if a fish has been selected.
...
$(document).ready(async () => {
    ...
    aquaTokenContract.createContract("0xa041cd3598cd1ffb917624540eb25bc5a6ae2d06"); //connect to deployed contract at given address
