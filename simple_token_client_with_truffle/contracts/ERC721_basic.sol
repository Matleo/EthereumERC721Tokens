...
import "./Libraries/Library_SafeMath.sol";
...
contract ERC721_basic is ERC721, ERC165 {
    ...
    mapping (uint256 => uint256) public ownedTokensIndex; // Mapping from token ID to index of the owner tokens list 
    ...
    constructor() public {
        create_token(msg.sender, 1);
        create_token(msg.sender, 99);
        create_token(msg.sender, 77);
    }
